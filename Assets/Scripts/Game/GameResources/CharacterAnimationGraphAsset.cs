...
[CreateAssetMenu(menuName = "NetCode/GhostAnimationGraph/Character")]
public class CharacterAnimationGraphAsset : GhostAnimationGraphAsset
{
...
public class StandGhostPlayableBehaviour : GhostPlayableBehaviour
{
    ...
    public override void PreparePredictedData(NetworkTick serverTick, float deltaTime, bool isRollback)
    {
        ...
        var localRot = /*quaternion.RotateY(input.Yaw)*/ quaternion.RotateY(0);
        ...
        if (standData.remainingTurnAngle != 0)
        {
            ...
            if (true/*!m_controller.ApplyRootMotion && input.Movement.x == 0 && input.Movement.y == 0 && character.OnGround == 1*/)
